...
LDFLAGS  = -lboost_thread -lboost_system -lboost_regex -lalut -lopenal
...
$(TARGET): $(OBJECTS)
	$(CXX) $(CXXFLAGS) -o $(TARGET) $(OBJECTS) $(LDFLAGS) $(LJULIUS) $(LOPENJTALK) $(LV8)

main.o home_automation_system.o:
	$(CXX) $(CXXFLAGS) -c $(@:.o=.cpp) $(IJULIUS) $(IOPENJTALK) $(IV8)
